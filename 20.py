...
flags.DEFINE_string('model_name','20','Filename of the model file')
...
training_files = ['train.tsv_0.1', 'train.tsv_0.2', 'train.tsv_0.3', 'train.tsv_0.4','train.tsv_0.5','train.tsv_0.6','train.tsv_0.7','train.tsv_0.8','train.tsv_0.9','train.tsv']
